            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 offset-md-3 list-group-item">
                        <form data-forge="<?php echo $_SESSION['forge'];  ?>"  action="#" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <article class="text-center" style="padding-top: 3em; padding-bottom: 3em">
                                ...
                                if(isset($_GET['trxref']) && !empty($_GET['reference'])){
                                     Validatepayment(mysqli_real_escape_string($link,$_GET['trxref']));
                                                                ...
                                                                <br/>Your affiliate account has been created,<br/> Click the button bellow to make payment<br/> <br/>
                                <h3><b>&#x20A6;1,000</b></h3>
...
<form >
  ...
  <button onclick="payWithPaystack()"type="button" class="btn btn-primary"><i class="fa fa-long-arrow-right"></i> Proceed</button>
</form>                           
                             ...
                             if(isset($_GET['rex'])){
                                 savePayment($_SESSION['aff_email'], 1000, mysqli_real_escape_string($link,$_GET['rex']), $_GET['data']);
                             }  
...
<script>
   function caveRun(resp,st){
       $.ajax({
                  type:'GET',
                  url:'<?= Inaki::path(); ?>payment?rex=' + resp + '&data=' + st,
                  success: function(){
                      $("#koglo").modal('show');
                  }
  ...
  function payWithPaystack(){
    var handler = PaystackPop.setup({
      key: 'pk_live_21266c01f84372304633682e423bc2d6d7536767',
      ...
      callback: function(response){
        let st =   JSON.stringify(response);
          if(response.reference === "") {
              ...
              alert("failed transaction, try again");
}else{
    caveRun(response.reference,st);
}
      ...
      <div class="modal-body">
          <form action="<?= Inaki::path();?>login"   method="post" accept-charset="utf-8">
              ...
              <div class="form-group">
                                    ...
                                    <input name="email" type="text" value="<?= $_SESSION['aff_email']; ?>" placeholder="email address" required class="form-control">
                                </div>
                                <div class="form-group">
