<!doctype html>
<html prefix="og: http://ogp.me/ns#" lang="en" class="no-js" itemscope='' itemtype='http://schema.org/WebPage'>

<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title><?php echo Inaki::app_name() . ' | ' .  $title;  ?></title>
    ...
    <meta property="og:description" content="Highlights from 2019 Grand Finale! Enter the <?= date('Y') ?> contest at https://metrobee.org.ng for N3k only. Register to spell your way to stardom!" />
    ...
    <!-- OG Meta Tags Twitter -->
    <link rel="manifest" href="<?= Inaki::path(); ?>manifest.json">
    ...
    <link rel="stylesheet" href="<?= Inaki::path() ?>css/bootstrap.min.css">

    <link rel="stylesheet" href="<?= Inaki::path(); ?>vendors/bootstrap-selector/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="<?= Inaki::path(); ?>vendors/animation/animate.css">
    <link rel="stylesheet" href="<?= Inaki::path(); ?>vendors/magnify-pop/magnific-popup.css">
    <link rel="stylesheet" href="<?= Inaki::path(); ?>vendors/nice-select/nice-select.css">
    <link rel="stylesheet" href="<?= Inaki::path(); ?>css/style.css">
    <link rel="stylesheet" href="<?= Inaki::path(); ?>css/responsive.css">
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <script src="<?= Inaki::path() ?>js/jquery-3.2.1.min.js"></script>
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "Campus Metro National Spelling Bee",
            "url": "metrobee.org.ng/",
            "sameAs": [
                "https://twitter.com/campusmetro",
                "https://www.instagram.com/campusmetrospellingbee/",
                "https://www.facebook.com/campusmetrospellingbee/",
                "https://metrobee.org.ng/"
            ],
            "logo": "https://scontent-lhr8-1.xx.fbcdn.net/v/t1.0-9/p960x960/44455637_307437329844855_8310299948646137856_o.jpg?_nc_cat=102&_nc_sid=85a577&_nc_ohc=i9Zk2HFuCykAX_wNDBr&_nc_ht=scontent-lhr8-1.xx&_nc_tp=6&oh=59b294795b538082c177a72c8597cb0e&oe=5EFBD398",
            "description": "Highlights of moments from the 2019 Grand Finale! Enter the <?= date('Y') ?> contest at www.metrobee.org.ng for a total of N3k only. Register to spell your way to stardom",
            "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "0812 973 2849",
